...
import {
    ...
    TweakpaneUiPlugin, AssetManagerBasicPopupPlugin,
} from "webgi";
...
const WebgiViewer = forwardRef((props, ref) => {

    {
        ...
        const setupViewer = useCallback(async () => {
            ...
            await manager.addFromPath("abass3.glb")
        ...
        const handleExit = useCallback(() => {
            ...
            gsap.to(positionRef, {
                ...
                x: !isMobile ? 0.13: 9.36,
                y: !isMobile ? 4.892 : 10.95 ,
                z: !isMobile ? 2.12  : 0.09,
